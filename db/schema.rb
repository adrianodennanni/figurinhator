...
ActiveRecord::Schema.define(version: 2018_03_21_024000) do
  ...
  create_table "figurinhas", force: :cascade do |t|
    ...
    t.bigint "user_id"
    t.bigint "figurinha_info_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["figurinha_info_id"], name: "index_figurinhas_on_figurinha_info_id"
  ...
  add_foreign_key "figurinhas", "figurinha_infos"
